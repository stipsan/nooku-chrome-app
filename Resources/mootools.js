...
// MooTools: the javascript framework.
// Load this file's selection again by visiting: http://mootools.net/more/a26f108afeb5443c717c65269ba98bcc 
// Or build this file again with packager using: packager build More/URI More/Keyboard
/*
---
copyrights:
  - [MooTools](http://mootools.net)
...
}});}).call(this);Events.Pseudos=function(g,c,e){var b="monitorEvents:";var a=function(h){return{store:h.store?function(i,j){h.store(b+i,j);}:function(i,j){(h.$monitorEvents||(h.$monitorEvents={}))[i]=j;
...
}a.manager._handle(g,g.type+":keys("+f.join("+")+")");};document.addEvents({keyup:d,keydown:d});}).call(this);